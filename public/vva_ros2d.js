...
ROS2D.OccupancyGrid = function(options) {
  ...
  for ( var row = 0; row < this.height; row++) {
    for ( var col = 0; col < this.width; col++) {
      ...
      var val = {r: 0, g: 0, b: 0, a: 0xff};
      if (data === 100) {
        // Color for obstacles
        val = {r: 0, g: 0, b: 0, a: 0xff};
      } else if (data === 0) {
        // Color for free space
        val = {r: 0xdd, g: 0xdd, b: 0xdd, a: 0xff};
      } else {
        // Color for unknown space
        val = {r: 0x30, g: 0x47, b: 0x5e, a: 0xff};
      }
